...
class UIScreenListener_ArmoryWeaponUpgrade extends UIScreenListener;
...
function EventListenerReturn OnWeaponUpgradeListChanged(Object EventData, Object EventSource, XComGameState GameState, Name InEventID, Object CallbackObject)
{
	local UIArmory_WeaponUpgrade UpgradeScreen;
...
{
	local Listener_XComGameState_Manager ListenerManager;

	if (!AddedNavHelp)
	{
		ListenerManager = class'Listener_XComGameState_Manager'.static.GetListenerManager();
		UpgradeScreen.NavHelp.AddLeftHelp(class'UIUtilities_LWOTC'.default.m_strStripWeaponUpgrades, "", ListenerManager.AvengerListener.OnStripUpgrades, false, class'UIUtilities_LWOTC'.default.m_strTooltipStripWeapons);
