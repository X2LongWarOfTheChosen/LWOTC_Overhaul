...
class HelpTemplate_X2StrategyElement extends X2StrategyElementTemplate;
...
static function AddHelpButton_Nav(name HelpTemplateName, optional ENavHelp_Side Side = eNavHelp_Left)
{
	...
	local HelpTemplate_X2StrategyElement HelpTemplate;
	...
	HelpTemplate = HelpTemplate_X2StrategyElement(StrategyTemplateMgr.FindStrategyElementTemplate(HelpTemplateName));
