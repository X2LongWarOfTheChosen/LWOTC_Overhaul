...
//---------------------------------------------------------------------------------------
class ActivityCreation_Reinforce extends ActivityCreation_LWOTC config(LWOTC_AlienActivities);
...
function int GetDesiredAlertLevel (XComGameState_WorldRegion RegionState) 
{
	...
	local WorldRegion_XComGameState_AlienStrategyAI RegionalAI, NeighborRegionStateAI;
...
function XComGameState_WorldRegion FindBestReinforceDestRegion(XComGameState NewGameState)
{
	...
	local WorldRegion_XComGameState_AlienStrategyAI DestRegionalAI;
...
function XComGameState_WorldRegion FindBestReinforceOrigRegion(XComGameState_WorldRegion DestRegionState, XComGameState NewGameState, optional out float BiggestDelta)
{
	...
	local WorldRegion_XComGameState_AlienStrategyAI OrigRegionalAI, DestRegionalAI;
	local AlienActivity_XComGameState ActivityState;
	local XComGameState_MissionSite MissionState;
