...
class Override_TemplateMods_Utilities extends Object;
...
static function UpdateTemplates()
{
    ...
    local Override_TemplateMods_Template				ModTemplate;
    local int idx;
    ...
    TemplateMods = StrategyTemplateMgr.GetAllTemplatesOfClass(class'Override_TemplateMods_Template');
    for (idx = 0; idx < TemplateMods.Length; ++idx)
    {
        ModTemplate = Override_TemplateMods_Template(TemplateMods[idx]);
...
static function PerformAbilityTemplateMod(Override_TemplateMods_Template Template, X2DataTemplateManager TemplateManager)
{
...
static function PerformCharacterTemplateMod(Override_TemplateMods_Template Template, X2DataTemplateManager TemplateManager)
{
...
static function PerformItemTemplateMod(Override_TemplateMods_Template Template, X2DataTemplateManager TemplateManager)
{
...
static function PerformStrategyElementTemplateMod(Override_TemplateMods_Template Template, X2DataTemplateManager TemplateManager)
{
...
static function PerformMissionNarrativeTemplateMod(Override_TemplateMods_Template Template, X2DataTemplateManager TemplateManager)
{
...
static function PerformHackRewardTemplateMod(Override_TemplateMods_Template Template, X2HackRewardTemplateManager TemplateManager)
{
...
static function PerformSoldierClassTemplateMod(Override_TemplateMods_Template Template, X2DataTemplateManager TemplateManager)
{
