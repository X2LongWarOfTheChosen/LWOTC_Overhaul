...
static function RemoveOrAdjustExistingActivitiesFromRegion(XComGameState_WorldRegion RegionState, XComGameState NewGameState)
{
	...
	foreach InfiltratedActivities(ActivityState)
	{
		...
		SquadState.CurrentInfiltration += default.INFILTRATION_BONUS_ON_LIBERATION[`DIFFICULTYSETTING] / 100.0;
...
static function TDateTime RegionalAvatarResearchTimer(XComGameState_LWAlienActivity ActivityState, optional XComGameState NewGameState)
{
	...
	else
	{
		...
		HoursToAdd = default.REGIONAL_AVATAR_RESEARCH_TIME_MIN[`DIFFICULTYSETTING];
		HoursToAdd += `SYNC_RAND_STATIC(default.REGIONAL_AVATAR_RESEARCH_TIME_MAX[`DIFFICULTYSETTING] - default.REGIONAL_AVATAR_RESEARCH_TIME_MIN[`DIFFICULTYSETTING] + 1);
	}
...
static function OnRegionalAvatarResearchUpdate(XComGameState_LWAlienActivity ActivityState, XComGameState NewGameState)
{
	...
	{
		if(`SYNC_FRAND_STATIC() >= default.CHANCE_TO_GAIN_DOOM_IN_SUPER_EMERGENCY[`DIFFICULTYSETTING] / 100.0)
			return;
	}
	...
	TransferChance = default.CHANCE_PER_LOCAL_DOOM_TRANSFER_TO_ALIEN_HQ[`DIFFICULTYSETTING] / 100.0;
...
static function TroopManeuversComplete (bool bAlienSuccess, XComGameState_LWAlienActivity ActivityState, XComGameState NewGameState)
{
	...
	if (!bAlienSuccess)
	{
		...
		if (`SYNC_RAND_STATIC(100) < default.TROOP_MANEUVERS_CHANCE_KILL_ALERT[`DIFFICULTYSETTING])
		{
