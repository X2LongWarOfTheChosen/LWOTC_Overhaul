...
//---------------------------------------------------------------------------------------
class X2StrategyElement_DefaultAlienActivities extends X2StrategyElement config(LW_Activities) dependson(UIMission_CustomMission, AlienActivity_X2StrategyElementTemplate);
...
static function RemoveOrAdjustExistingActivitiesFromRegion(XComGameState_WorldRegion RegionState, XComGameState NewGameState)
{
	...
	foreach InfiltratedActivities(ActivityState)
	{
		...
		SquadState.CurrentInfiltration += default.INFILTRATION_BONUS_ON_LIBERATION[`CAMPAIGNDIFFICULTYSETTING] / 100.0;
