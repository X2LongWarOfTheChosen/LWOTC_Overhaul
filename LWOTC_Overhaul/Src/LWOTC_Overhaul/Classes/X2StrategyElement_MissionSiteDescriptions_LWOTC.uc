class X2StrategyElement_MissionSiteDescriptions_LWOTC extends X2StrategyElement_DefaultMissionSiteDescriptions;

var localized string m_strLiberatedCityPrefix;

static function string GetCityCenterMissionSiteDescription_LWOTC(string BaseString, XComGameState_MissionSite MissionSite)
{
